  ...
  <thead class="table">
    ...
    <tbody class="table">
      @foreach($curs as $cursos)
        ...
        <a href="{{ route('cursos.destroy', $cursos->id) }}" onclick="return confirm('Seguro que deseas eliminarlo?')" class="btn btn-danger"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> </a>      
        </td>           
        </tr>
      @endforeach
    </tbody>      
